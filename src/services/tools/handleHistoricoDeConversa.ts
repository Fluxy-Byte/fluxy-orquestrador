...
export async function handleHistoricoDeConversa(numeroDoContato: string, id_agent: string, repostaEnviada: string, tipoDaMensagem: string, mensagemRecebida: string, timesTampMensagem: string, status: string, dadosDoWaba: Metadata) {
