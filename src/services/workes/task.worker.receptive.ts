...
import { updateNumberContactsWaba } from '../../infra/dataBase/waba';
    ...
    channel.consume(queue, async (msg: any) => {
        ...
        try {
            ...
            if (dadosDaMesagen.value.messages) {
                ...
                const agent = await getAgentFilterWithPhoneNumberId(dadosDoWaba.phone_number_id);

                updateNumberContactsWaba(dadosDoWaba.phone_number_id);
